...
QSize LineNumberArea::sizeHint() const {
    return QSize(((ClaraEditor *)codeEditor)->lineNumberAreaWidth(), 0);
}

void LineNumberArea::paintEvent(QPaintEvent *event) {
    ((ClaraEditor *)codeEditor)->lineNumberAreaPaintEvent(event);
}


ClaraEditor::ClaraEditor()
{
    // Line numbers
...
int ClaraEditor::lineNumberAreaWidth()
{
    int digits = 1;
...
void ClaraEditor::updateLineNumberAreaWidth(int /* newBlockCount *///)
/*{
    setViewportMargins(lineNumberAreaWidth(), 0, 0, 0);
}


void ClaraEditor::updateLineNumberArea(QRectF /*rect_f*///)
/*{
    ClaraEditor::updateLineNumberArea();
}
void ClaraEditor::updateLineNumberArea(int /*slider_pos*///)
/*{
    ClaraEditor::updateLineNumberArea();
}
void ClaraEditor::updateLineNumberArea()
{
    /*
...
void ClaraEditor::resizeEvent(QResizeEvent *e)
{
...
int ClaraEditor::getFirstVisibleBlockId()
{
...
void ClaraEditor::lineNumberAreaPaintEvent(QPaintEvent *event)
{
    this->verticalScrollBar()->setSliderPosition(this->verticalScrollBar()->sliderPosition());
